...
export const getWeather =async (placeText) => {
        ...
        const response = await fetch(`https://cors-anywhere.herokuapp.com/api.weatherstack.com/current?access_key=757b249e342efe42f0446d92194588fe&query=${placeText || 'Mexico'}`);
